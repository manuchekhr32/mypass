...
describe('Functions / generatePassword', () => {
  test('Low level', () => {
    ...
    expect(generatePassword(PasswordLevel.LOW)).toMatch(
      /(?=.*[a-z])(?=.*[A-Z])/g
    )
  ...
  test('Medium level', () => {
    ...
    expect(generatePassword(PasswordLevel.MEDIUM)).toMatch(
      /(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])/g
    )
  ...
  test('High level', () => {
    ...
    expect(generatePassword(PasswordLevel.HIGH)).toMatch(
      /(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])/g
    )
